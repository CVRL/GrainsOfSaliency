...
from dataset_Loader_original import datasetLoader
...
parser.add_argument('-csvPath', required=False, default= 'train.csv',type=str)
parser.add_argument('-datasetPath', required=False, default= '../path/to/Data/',type=str)
parser.add_argument('-outputPath', required=False, default= '../model/output/path/',type=str)
parser.add_argument('-heatmaps', required=False, default= '../path/to/saliency/maps/',type=str)
